class Employee:
    @classmethod
    def getcompany(cls): #class level Method
        cls.cname="TCS"   #class Level Data Member
        cls.getcompadd() #calling class level method w.r.t cls
    @classmethod
    def getcompadd(cls):  #class level Method
        
          cls.addr="HYD" #class Level Data Member
    ...
    def  dispempdata(self):
     #   self.getcompany()
       ...
       print("Comapny Address={}".format(self.addr))
